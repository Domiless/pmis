    ...
    <a-layout id="components-layout">
            ...
            >
              <a-form :form="form">
                ...
                <a-form-item :wrapper-col="{ span:18,offset: 5 }" style="text-align:right">
                  <a-button
                    @click="changePassword=false;form.resetFields();"
      ...
      <a-layout>
        ...
        >
          <a-menu
            mode="inline"
            :defaultOpenKeys="['workdesk','system','enterprise','workOrder','process','materialManagement','dataAnalysis','project','procurement','design','warehouse']"
            :selectable="false"
