...
export default {
  ...
  methods: {
    ...
    showEdit() {
      ...
      setTimeout(() => {
        this.form.setFieldsValue({
          name: this.defaultValue[0].unitName,
    ...
    onDelete(e) {
      ...
      this.Axios(
        {
          url: "/api-warehouse/unit/del?id=" + this.selectedRowKeys[0],
          params: {},
          type: "delete",
