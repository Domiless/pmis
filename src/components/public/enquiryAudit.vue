      ...
      <a-col :span="12" style="margin-bottom: -1000px;padding-bottom: 1000px;float: left;">
        <a-col :span="24" style="padding-top:20px;padding-bottom:20px;">
          <a-col :span="24" class="case">
            <span class="audit_label">报审单编号</span>
            <span>{{detailsValue.DO.purchaseNo}}</span>
          </a-col>
          <a-col :span="24" class="case">
            <span class="audit_label">标题</span>
            <span>{{detailsValue.DO.title}}</span>
          </a-col>
          <a-col :span="24" class="case">
            <span class="audit_label">拟制</span>
            <span>{{detailsValue.DO.production}}</span>
          </a-col>
          <a-col :span="24" class="case">
            <span class="audit_label">填报日期</span>
