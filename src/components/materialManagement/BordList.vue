		...
		>
			<a-form :form="form" layout="inline" style="overflow:hidden" @keyup.enter.native="edit">
				...
				<a-col :span="12">
					<a-form-item label="长">
						<a-input
							v-decorator="['lengthOrRadius',{rules: [{ required: true, message: '请填写长' },{validator: chickNumberFloat}]}]"
							type="number"
				...
				<a-col :span="12">
					<a-form-item label="宽">
						<a-input
							v-decorator="['widthOrRadius',{rules: [{ required: true, message: '请填写宽' },{validator: chickNumberFloat}]}]"
							type="number"
							oninput="if(value.length>10)value=value.slice(0,10)"
							style="width:260px;"
							addonAfter="mm"
				...
				<a-col :span="12">
					<a-form-item label="厚">
						<a-input
							v-decorator="['heightOrLength',{rules: [{ required: true, message: '请填写厚' },{validator: chickNumberFloat}]}]"
							type="number"
							oninput="if(value.length>10)value=value.slice(0,10)"
							style="width:260px;"
							addonAfter="mm"
