  ...
  <div class="orderManage">
    ...
    <div class="orderManage_content">
      <div class="content_wrap">
        ...
        >
              <a slot="contractName" slot-scope="details" href="javascript:;" @click="sendDetails()">{{ details }}</a>
    ...
    <a-modal
     ...
     :footer="null"
     >
      <add-order-message @changeAddOrder="cancelAddOrder"></add-order-message>
    </a-modal>
    ...
    <a-modal
     ...
     @cancel="closeDetails"
    >
    <Details :sendId="selectedRowKeys[0]"></Details>
    <a-row type="flex" justify="end">
      <a-button type="primary" @click="showDetails=false">关闭</a-button>
    </a-row>
    </a-modal>
    <a-modal
			title="修改工单"
