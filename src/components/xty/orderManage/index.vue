<template>
	<div class="orderManage">
			...
			<div class="header_wrap">
				<a-row>
					<a-col style="line-height:50px;">
						<permission-button permCode="order_lookup.order_add" banType="hide" @click="addVisible=true">
							<a-icon type="plus" style="color: #1890ff" />新增
						</permission-button>
						<permission-button
							permCode="order_lookup.order_update"
							banType="hide"
							@click="editShow"
						...
						<permission-button
							permCode="order_lookup.order_audit"
							banType="hide"
							@click="approveShow"
							:disabled="selectedRowKeys.length!=1"
						>
						...
						<permission-button
							permCode="order_lookup.order_delete"
							banType="hide"
		...
		>
			<edit-order-message
				:OrderMessageId="selectedRowKeys[0]"
				@cancelEdit="cancelEdit"
				ref="editOrderMessage"
			></edit-order-message>
		</a-modal>
		<a-modal
			title="详情"
...
export default {
	...
	methods: {
		...
		editShow() {
			if (
				this.selectedRows[0].orderReviewSchedule != 1 &&
				this.selectedRows[0].orderReviewSchedule != 4
			) {
