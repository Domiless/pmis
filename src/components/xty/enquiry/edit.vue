<template>
	<div class="enquiry_edit">
		...
		>
			...
			<template
				v-for="col in ['shopName', 'orderNumber','firstOffer','secondOffer','thirdOffer','remark']"
				:slot="col"
			...
			<template v-for="j in ['moneyType']" :slot="j" slot-scope="text, record, index">
				<div :key="j">
					<a-input :value="text" @change="e => handleChange(e.target.value, record.id, j)"></a-input>
				</div>
			</template>
...
export default {
	...
	methods: {
		toSave() {
			if (
				this.data
					.map(item => item.orderNumber != null && item.orderNumber != "")
			...
			if (
				this.data
					.map(item => item.unitId != null && item.unitId != "")
					.find(item => item != false) == undefined
			) {
			...
			if (
				this.data
					.map(item => item.delivery != null && item.delivery != "")
					.find(item => item != false) == undefined
			) {
			...
			if (
				this.data
					.map(
						item => item.firstSupplierId != null && item.firstSupplierId != ""
					)
					.find(item => item != false) == undefined
			) {
			...
			if (
				this.data
					.map(item => item.firstOffer != null && item.firstOffer != "")
					.find(item => item != false) == undefined
			) {
			...
			if (
				this.data
					.map(item => item.supplierId != null && item.supplierId != "")
					.find(item => item != false) == undefined
			) {
			...
			if (
				this.data
					.map(item => item.priseUnitId != null && item.priseUnitId != "")
					.find(item => item != false) == undefined
			) {
