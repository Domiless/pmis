  ...
  <div class="preview">
    ...
    <a-row>
        <table class="table_style">
            <tr>
                <th :colspan="2" style="text-align: left">业务归口部门：</th>
                <td style="text-align: left">{{ procurementMsg.relevant }}</td>
                <th style="text-align: right">提采时间：</th>
                <td :colspan="2">{{ procurementMsg.raisedate }}</td>
                <th style="text-align: right">编号：</th>
                <td :colspan="4">{{ procurementMsg.no }}</td>
            </tr>
            <tr>
                <th :colspan="2" style="text-align: left">订单号：</th>
                <td style="text-align: left">{{ procurementMsg.bomNo }}</td>
            ...
            <tr v-for="(item,i) in procurementMsg.bomDes" :key="i+8888">
              ...
              <td style="width:20%;text-align:left">{{ item.partCat }}</td>
              <td style="width:5%">{{ item.unit }}</td>
              <td style="width:4%">{{ item.addNum }}</td>
              <td style="width:10%;text-align:left">{{ item.adviseBrand }}</td>
              <td style="width:10%;text-align:left">{{ item.brand }}</td>
              <td style="width:10%">{{ item.arrivalTime }}</td>
              <td style="width:10%">{{ item.remake }}</td>
              <td style="width:5%"></td>
            </tr>
          </table>
